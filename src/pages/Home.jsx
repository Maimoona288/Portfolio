    ...
    >
      <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-lg sm:text-xl md:text-2xl text-slate-800">
          ...
          <button className="mt-6 font-semibold bg-indigo-700 text-white px-6 py-3 rounded-lg hover:bg-indigo-800 transition duration-300">
            View Projects
          </button>
        </div>
